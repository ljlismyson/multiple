"""Linear-position Attention U-Net training with weighted MSE+L1 residual loss.

Windows:
    conda run -n segy python scripts/coherent_noise_attenuation/train_diffraction_multiples_atten_unet_posenc_mse_l1.py
"""
...
_DEFAULT_CONFIG = (
    ...
    / "diffraction_multiples_atten_unet_posenc_mse_l1.yaml"
)
...
def _load_base_main():
    spec = importlib.util.spec_from_file_location("_atten_unet_posenc_mse_l1_base_train", _BASE_SCRIPT)
