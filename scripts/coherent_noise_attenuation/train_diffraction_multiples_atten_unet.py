"""Diffraction-multiple attenuation: paired volumes + supervised patch training.

Windows:
    conda run -n segy python scripts/coherent_noise_attenuation/train_diffraction_multiples_atten_unet.py \
        --config configs/coherent_noise_attenuation/diffraction_multiples_atten_unet.yaml
Linux/DDP:
    torchrun --nproc_per_node=2 scripts/coherent_noise_attenuation/train_diffraction_multiples_atten_unet.py \
        --config configs/coherent_noise_attenuation/diffraction_multiples_atten_unet.yaml
"""
